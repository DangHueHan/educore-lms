...
async function main() {
  ...
  const coursesData = [
    {
      ...
      questions: [
        {
          id: 'que-c1-1', question: 'Từ khóa nào dùng để khai báo một biến có thể gán lại giá trị trong JS?',
          answers: [
        ...
        {
          id: 'que-c1-2', question: 'Kết quả của biểu thức "5" + 2 trong JavaScript là gì?',
          answers: [
        ...
        {
          id: 'que-c1-3', question: 'Hàm nào dùng để chuyển đổi một chuỗi JSON thành một đối tượng JS?',
          answers: [
        ...
        {
          id: 'que-c1-4', question: 'Phương thức mảng nào dùng để lọc ra các phần tử thỏa mãn điều kiện?',
          answers: [
        ...
        {
          id: 'que-c1-5', question: 'Đâu không phải là một trạng thái của một Promise?',
          answers: [
        ...
        {
          id: 'que-c1-6', question: 'Toán tử so sánh nghiêm ngặt (kiểm tra cả giá trị và kiểu dữ liệu) là toán tử nào?',
          answers: [
        ...
        {
          id: 'que-c1-7', question: 'Lệnh "typeof null" trả về giá trị gì?',
          answers: [
        ...
        {
          id: 'que-c1-8', question: 'Sự kiện DOM nào kích hoạt khi người dùng click chuột vào một phần tử?',
          answers: [
        ...
        {
          id: 'que-c1-9', question: 'Phương thức nào thêm một phần tử vào cuối mảng?',
          answers: [
        ...
        {
          id: 'que-c1-10', question: 'Mục đích chính của "use strict" trong file JS là gì?',
          answers: [
    ...
    },
    {
      ...
      questions: [
        {
          id: 'que-c2-1', question: 'ReactJS là một thư viện dùng để phát triển thành phần nào của ứng dụng?',
          answers: [
        ...
        {
          id: 'que-c2-2', question: 'Hook nào dùng để quản lý trạng thái cục bộ trong một Functional Component?',
          answers: [
        ...
        {
          id: 'que-c2-3', question: 'Cú pháp mở rộng viết mã HTML trực tiếp trong file JavaScript của React gọi là gì?',
          answers: [
        ...
        {
          id: 'que-c2-4', question: 'Khi truyền dữ liệu từ Component cha xuống Component con, ta sử dụng khái niệm nào?',
          answers: [
        ...
        {
          id: 'que-c2-5', question: 'Hook nào tương ứng với các vòng đời (lifecycle) như componentDidMount và componentDidUpdate?',
          answers: [
        ...
        {
          id: 'que-c2-6', question: 'Thuộc tính bắt buộc phải thêm khi render một danh sách các phần tử bằng hàm map() là gì?',
          answers: [
        ...
        {
          id: 'que-c2-7', question: 'Làm thế nào để ngăn chặn một Component re-render không cần thiết khi dữ liệu không đổi?',
          answers: [
        ...
        {
          id: 'que-c2-8', question: 'Để lưu trữ một tham chiếu không làm thay đổi giao diện (re-render) khi cập nhật, ta dùng Hook nào?',
          answers: [
        ...
        {
          id: 'que-c2-9', question: 'Trong React, "Virtual DOM" cập nhật thật sự vào Browser DOM thông qua quy trình nào?',
          answers: [
        ...
        {
          id: 'que-c2-10', question: 'Thư viện phổ biến dùng để quản lý định tuyến (Routing) trong React là gì?',
          answers: [
    ...
    },
    {
      ...
      questions: [
        {
          id: 'que-c3-1', question: 'UX là viết tắt của cụm từ tiếng Anh nào?',
          answers: [
        ...
        {
          id: 'que-c3-2', question: 'Quy trình tạo bản phác thảo cấu trúc thô (đen trắng) của màn hình gọi là gì?',
          answers: [
        ...
        {
          id: 'que-c3-3', question: 'Khoảng cách trống bao quanh các phần tử thiết kế giúp giao diện thoáng đãng gọi là gì?',
          answers: [
        ...
        {
          id: 'que-c3-4', question: 'Công cụ thiết kế giao diện UI/UX chạy trên nền tảng Web phổ biến nhất hiện nay?',
          answers: [
        ...
        {
          id: 'que-c3-5', question: 'Yếu tố nào giúp dẫn dắt mắt người dùng đọc thông tin quan trọng trước dựa vào độ lớn, màu sắc chữ?',
          answers: [
        ...
        {
          id: 'que-c3-6', question: 'Một nút bấm (Button) có đổ bóng nhẹ tạo cảm giác nổi lên để click được gọi là áp dụng nguyên lý nào?',
          answers: [
        ...
        {
          id: 'que-c3-7', question: 'Kiểm thử sản phẩm bằng cách cho người dùng trực tiếp thao tác và theo dõi khó khăn của họ gọi là gì?',
          answers: [
        ...
        {
          id: 'que-c3-8', question: 'Màu sắc chủ đạo trong một sản phẩm thường chiếm bao nhiêu phần trăm theo quy tắc 60-30-10?',
          answers: [
        ...
        {
          id: 'que-c3-9', question: '"Chỉ số đo lường mức độ người dùng rời bỏ ứng dụng sau một thời gian ngắn sử dụng" gọi là gì?',
          answers: [
        ...
        {
          id: 'que-c3-10', question: 'Khi thiết kế nút bấm trên di động, kích thước vùng chạm tối thiểu khuyến nghị của Google/Apple để tránh bấm nhầm là bao nhiêu?',
          answers: [
    ...
    },
    {
      ...
      questions: [
        {
          id: 'que-c4-1', question: 'Node.js bản chất thực sự là gì?',
          answers: [
        ...
        {
          id: 'que-c4-2', question: 'Cơ chế cốt lõi giúp Node.js xử lý hàng nghìn kết nối đồng thời với cấu trúc đơn luồng (Single-thread) là gì?',
          answers: [
        ...
        {
          id: 'que-c4-3', question: 'Phương thức HTTP nào được khuyến nghị để cập nhật một phần dữ liệu của bản ghi?',
          answers: [
        ...
        {
          id: 'que-c4-4', question: 'Mã trạng thái HTTP (Status Code) nào đại diện cho lỗi Không tìm thấy tài nguyên (Not Found)?',
          answers: [
        ...
        {
          id: 'que-c4-5', question: 'Framework tối giản phổ biến nhất của Node.js để tạo HTTP Server và định tuyến Router là gì?',
          answers: [
        ...
        {
          id: 'que-c4-6', question: 'Trong Express, các hàm chạy trung gian nằm giữa Request và Response dùng để kiểm tra đăng nhập/xử lý lỗi gọi là gì?',
          answers: [
        ...
        {
          id: 'que-c4-7', question: 'Để băm (hash) mật khẩu của người dùng an toàn trước khi lưu vào DB, thư viện nào được khuyên dùng?',
          answers: [
        ...
        {
          id: 'que-c4-8', question: 'JWT (JSON Web Token) gồm có bao nhiêu phần được phân tách bằng dấu chấm (.)?',
          answers: [
        ...
        {
          id: 'que-c4-9', question: 'Thư viện/Công cụ quản lý gói mặc định đi kèm khi cài đặt Node.js là gì?',
          answers: [
        ...
        {
          id: 'que-c4-10', question: 'Biến toàn cục nào chứa các tham số cấu hình môi trường hệ thống trong Node.js?',
          answers: [
    ...
    },
    {
      ...
      questions: [
        {
          id: 'que-c5-1', question: 'Kiểu dữ liệu nào trong Python là danh sách có thứ tự nhưng KHÔNG THỂ chỉnh sửa (immutable)?',
          answers: [
        ...
        {
          id: 'que-c5-2', question: 'Thư viện cốt lõi chuyên dùng để xử lý mảng nhiều chiều và tính toán đại số tuyến tính tốc độ cao là gì?',
          answers: [
        ...
        {
          id: 'que-c5-3', question: 'Cấu trúc dữ liệu dạng bảng 2 chiều gồm hàng và cột trong thư viện Pandas gọi là gì?',
          answers: [
        ...
        {
          id: 'que-c5-4', question: 'Hàm nào trong Pandas dùng để xem 5 dòng đầu tiên của một tập dữ liệu?',
          answers: [
        ...
        {
          id: 'que-c5-5', question: 'Để loại bỏ các giá trị bị khuyết/rỗng (NaN) trong bảng dữ liệu Pandas, ta dùng phương thức nào?',
          answers: [
        ...
        {
          id: 'que-c5-6', question: 'Đâu là thư viện dùng để vẽ biểu đồ và trực quan hóa dữ liệu cơ bản trong Python?',
          answers: [
        ...
        {
          id: 'que-c5-7', question: 'Để định nghĩa một hàm tự chế trong Python, bạn bắt đầu bằng từ khóa nào?',
          answers: [
        ...
        {
          id: 'que-c5-8', question: 'Khối lệnh nào dùng để xử lý ngoại lệ (bắt lỗi) để ứng dụng không bị crash trong Python?',
          answers: [
        ...
        {
          id: 'que-c5-9', question: 'Cách lấy độ dài của một List có tên là my_list trong Python?',
          answers: [
        ...
        {
          id: 'que-c5-10', question: 'Thuật toán Linear Regression thuộc nhóm học máy (Machine Learning) nào?',
          answers: [
  ...
  // ================= ENROLLMENTS + PROGRESS (FIXED LESSON INDEX) + QUIZ RESULTS
  const enrollData = [
    { userId: 'user-2', courseId: 'course-1', progress: 100, lastLesson: 3, correctAnswers: 9 },   // 90%
    { userId: 'user-2', courseId: 'course-2', progress: 65,  lastLesson: 2, correctAnswers: 7 },   // 70%
    { userId: 'user-3', courseId: 'course-1', progress: 45,  lastLesson: 1, correctAnswers: 6 },   // 60%
    { userId: 'user-3', courseId: 'course-3', progress: 100, lastLesson: 3, correctAnswers: 4 },   // 40%
    { userId: 'user-4', courseId: 'course-2', progress: 30,  lastLesson: 1, correctAnswers: null }, // Chưa thi
    { userId: 'user-5', courseId: 'course-4', progress: 80,  lastLesson: 2, correctAnswers: 8 },   // 80%
    { userId: 'user-5', courseId: 'course-5', progress: 55,  lastLesson: 2, correctAnswers: 5 },   // 50%
  ];
  ...
  for (const e of enrollData) {
    ...
    await prisma.enrollment.create({
      data: { 
        id: `enrol-${e.userId}-${e.courseId}`, 
        userId: e.userId, 
        courseId: e.courseId 
      },
    });

    // Course Progress (Dữ liệu đã chuẩn hóa theo thực tế bài học, không dùng hàm làm tròn lỗi)
  ...
  await prisma.session.createMany({
    data: [
      { id: 'sess-1', userId: 'user-1', token: 'token-admin', expiresAt: new Date('2026-12-31') },
      { id: 'sess-2', userId: 'user-2', token: 'token-student1', expiresAt: new Date('2026-12-31') },
      { id: 'sess-3', userId: 'user-3', token: 'token-student2', expiresAt: new Date('2026-12-31') },
    ],
  });
